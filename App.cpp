...
{
	GUIUpdate();
	//Reset the command list to prevent memory leak
...
void App::GUIInit()
{
	...
	ImGui_ImplDX12_Init(md3dDevice.Get(), 3, DXGI_FORMAT_R8G8B8A8_UNORM, mCbvHeap->GetCPUDescriptorHandleForHeapStart(), mCbvHeap->GetGPUDescriptorHandleForHeapStart());
